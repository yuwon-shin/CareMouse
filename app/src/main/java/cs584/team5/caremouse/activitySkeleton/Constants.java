...
public class Constants {
    // Parameters
    //public final static String[] CLASS_LABELS = {"1", "2", "3"}; // Should be predefined before collecting data
    //public final static String[] ARFF_FILE_NAMES = {"1.txt", "2.txt", "3.txt"}; // Will be used for model building after merging

    public final static String[] CLASS_LABELS = {"1", "2", "3","4","5"}; // Should be predefined before collecting data
    public final static String[] ARFF_FILE_NAMES = {"1.txt", "2.txt", "3.txt","4.txt","5.txt"};
