package cs584.team5.caremouse.blunobasicdemo;
...
import cs584.team5.caremouse.R;
...
//	byte[] mBaudrateBuffer={0x32,0x00,(byte) (mBaudrate & 0xFF),(byte) ((mBaudrate>>8) & 0xFF),(byte) ((mBaudrate>>16) & 0xFF),0x00};;
    ...
    public void onPauseProcess() {
        ...
        {
            //mBluetoothLeService.disconnect(); 수정
    ...
    private class LeDeviceListAdapter extends BaseAdapter {
        ...
        public void addDevice(BluetoothDevice device) {
            if (!mLeDevices.contains(device)) {
                if(device.getAddress().equals("F4:B8:5E:41:27:73") || device.getAddress().equals("80:30:DC:E9:1C:7F"))
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (deviceName != null && deviceName.substring(0,5).equals("Bluno"))
